...
func uniffiCheckChecksums() {
	...
	{
	checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
		return C.uniffi_radix_engine_toolkit_uniffi_checksum_func_derive_virtual_global_caller_non_fungible_global_id_from_component_address(uniffiStatus)
	})
	if checksum != 55602 {
		// If this happens try cleaning and rebuilding your project
		panic("radix_engine_toolkit_uniffi: uniffi_radix_engine_toolkit_uniffi_checksum_func_derive_virtual_global_caller_non_fungible_global_id_from_component_address: UniFFI API checksum mismatch")
	}
	}
	{
	checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
	checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
		return C.uniffi_radix_engine_toolkit_uniffi_checksum_func_derive_virtual_package_of_direct_caller_non_fungible_global_id_from_component_address(uniffiStatus)
	})
	if checksum != 42759 {
		// If this happens try cleaning and rebuilding your project
		panic("radix_engine_toolkit_uniffi: uniffi_radix_engine_toolkit_uniffi_checksum_func_derive_virtual_package_of_direct_caller_non_fungible_global_id_from_component_address: UniFFI API checksum mismatch")
	}
	}
	{
	checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
...
func (_self *TransactionManifest)ExecutionSummary(networkId uint8, toolkitReceipt string) (ExecutionSummary, error) {
	_pointer := _self.ffiObject.incrementPointer("*TransactionManifest")
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeRadixEngineToolkitError{},func(_uniffiStatus *C.RustCallStatus) RustBufferI {
...
func DeriveVirtualGlobalCallerNonFungibleGlobalIdFromComponentAddress(componentAddress *Address, networkId uint8) (*NonFungibleGlobalId, error) {
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeRadixEngineToolkitError{},func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.uniffi_radix_engine_toolkit_uniffi_fn_func_derive_virtual_global_caller_non_fungible_global_id_from_component_address(FfiConverterAddressINSTANCE.Lower(componentAddress), FfiConverterUint8INSTANCE.Lower(networkId), _uniffiStatus)
	})
		if _uniffiErr != nil {
			var _uniffiDefaultValue *NonFungibleGlobalId
			return _uniffiDefaultValue, _uniffiErr
...
func DeriveVirtualPackageOfDirectCallerNonFungibleGlobalIdFromComponentAddress(packageAddress *Address, networkId uint8) (*NonFungibleGlobalId, error) {
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeRadixEngineToolkitError{},func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.uniffi_radix_engine_toolkit_uniffi_fn_func_derive_virtual_package_of_direct_caller_non_fungible_global_id_from_component_address(FfiConverterAddressINSTANCE.Lower(packageAddress), FfiConverterUint8INSTANCE.Lower(networkId), _uniffiStatus)
	})
		if _uniffiErr != nil {
			var _uniffiDefaultValue *NonFungibleGlobalId
			return _uniffiDefaultValue, _uniffiErr
